...
try {
  ...
  $prepare = $pdo->prepare("insert into `sala03` (`nome`, `data_de_nascimento`, `serie`, `turma`) values (:nome, :data_de_nascimento, :serie, :turma)");
  ...
  $prepare->bindParam(':turma', $turma, PDO::PARAM_STR);
          ...
          header("Location: sala03.php?mensagem=O aluno ". $nome ." foi inserido com sucesso!!");
