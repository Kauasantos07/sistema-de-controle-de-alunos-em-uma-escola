...
// Estabelece a conexão com o banco de dados
    try {
      ...
      $registros = $pdo->query("SELECT * FROM sala03 WHERE id LIKE '%$search%' OR nome LIKE '%$search%' OR data_de_nascimento LIKE '%$search%' OR serie LIKE '%$search%' OR turma LIKE '%$search%' OR nota LIKE '%$search%' ORDER BY id,nome,nota DESC");
...
//Faça isso se nao funcionar
     ...
     try {
      ...
      $registros = $pdo->query("SELECT * FROM sala03");
...
<html lang="pt-br">
  <head>
    ...
    <title>Sala 03</title>
    <link rel="stylesheet" href="css\estilosala03.css">
    <meta charset="utf-8">
    <style>
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="main-table">
          <h1 style="text-align: center">Alunos da sala 03</h1>
